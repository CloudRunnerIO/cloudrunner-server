...
Revision ID: 4507554a6d60
Revises: None
Create Date: 2014-09-12 19:34:41.450974

"""

# revision identifiers, used by Alembic.
revision = '4507554a6d60'
down_revision = None
...
def upgrade():
    ...
    sa.Column('scope', sa.Enum('LOGIN', 'TRIGGER', 'EXECUTE'), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('script_part', sa.Integer(), nullable=True),
    sa.Column('owner_id', sa.Integer(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['started_by_id'], ['jobs.id'], ),
    sa.ForeignKeyConstraint(['taskgroup_id'], [u'taskgroups.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
